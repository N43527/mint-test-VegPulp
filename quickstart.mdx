...
Describe how someone begins using your product. hihihiWhat is the first thing they need to do? Are there any prerequisites?

A quickstart should take someone from zero to using your product. They'll get a quick win and a sense of what they can accomplish.<br />gg<br />new change $$E = mc^2$$  is what i would say `llmBaseUrl` is one type of url while  `anotherLLMurl` is another type of url
